  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="dospem.html">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../Template/skydash/pages/ui-features/buttons.html">Tugas Akhir</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../Template/skydash/pages/ui-features/dropdowns.html">Seminar Proposal</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../Template/skydash/pages/ui-features/typography.html">Ujian Akhir</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="../../Template/skydash/images/dashboard/people.svg" alt="people">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        <img src="../../Template/skydash/images/faces/face1.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="../../Template/skydash/images/faces/face2.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                      <img src="../../Template/skydash/images/faces/face3.jpg" alt="user">
                     <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="../../Template/skydash/images/faces/face4.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="../../Template/skydash/images/faces/face5.jpg" alt="user">
                        <div>
